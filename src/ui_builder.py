    ...
    function renderCards() {
      ...
      sortedJobs.forEach((job, idx) => {
        ...
        card.innerHTML = `
          ...
          <div class="flex items-start justify-between gap-3 border-b border-slate-800/80 pb-3 mb-3.5">
            <div class="flex items-start gap-3 flex-1 min-w-0">
              ...
              <div class="flex-1 min-w-0">
                ...
                <!-- Sub-header: דרישות החברה עבור המשרה (Inline Flow) -->
                <div class="mt-2 text-xs bg-slate-950/80 border border-sky-500/25 rounded-xl px-3.5 py-2.5 text-slate-300 shadow-inner leading-relaxed break-words">
                  <span class="font-bold text-sky-400 inline-block ml-1.5">
          ...
          <!-- 3 Clean, Non-Redundant Sections (Inline Flow: continuous text, 100% full width, zero word hiding) -->
          <div class="grid grid-cols-1 gap-2.5 text-xs md:text-sm">
            <div class="bg-slate-950/60 p-2.5 sm:p-3 rounded-xl border border-slate-800/60 leading-relaxed break-words">
            ...
            <div class="bg-emerald-950/20 p-2.5 sm:p-3 rounded-xl border border-emerald-800/40 leading-relaxed break-words">
